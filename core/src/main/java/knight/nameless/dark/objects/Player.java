...
import static knight.nameless.dark.helpers.GameDataHelper.loadPlayerPosition;
...
public class Player extends GameObject {
    ...
    public Player(Rectangle bounds, World world, TextureAtlas atlas) {
        ...
        dyingAnimation = makeAnimation(atlas.findRegion("dying"), 8, 0.1f);
    ...
    private void movement() {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.SPACE) && body.getLinearVelocity().y == 0) {
            ...
            applyLinealImpulse(new Vector2(0, 130));
            jumpSound.play();
        }
    }
